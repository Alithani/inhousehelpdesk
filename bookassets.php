...
<div class="container-fluid"  id="main">
  <form class="form-horizontal" role="form" id="frminput" method="post" enctype="multipart/form-data">
    <fieldset>
    <center>
      ...
      <div class="form-group" >
        ...
        <div class="col-sm-6 w3-panel w3-card">
          <input type="text" class="form-control" name="fname" id="fname" placeholder="<?php echo $fname;?>"  readonly>
        </div>
      </div>
      <div class="form-group">
